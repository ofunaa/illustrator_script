...
function set_content(one_page){
	for(i=0; i<one_page.length; i++){
		...
		set_choices(main_content[0],main_content[2],main_content[4],main_content[6]);
		set_ruby(main_content[1],main_content[3],main_content[5],main_content[7]);
	}
}
...
function set_ruby(one,two,three,four){
	set_ruby_text(-40,0,600,100, one);
	set_ruby_text(-40,610,600,100, two);
	set_ruby_text(-40,1220,600,100, three);
	set_ruby_text(-40,1830,600,100, four);
}
